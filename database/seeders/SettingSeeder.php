...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['group' => 'email', 'key' => 'mail_from_name', 'value' => 'JustBurgers', 'type' => 'string'],

            // SEO Settings
            ['group' => 'seo', 'key' => 'meta_title', 'value' => 'JustBurgers - Your Go-To Store for Mobile Accessories', 'type' => 'string'],
            ['group' => 'seo', 'key' => 'meta_description', 'value' => 'Shop mobile accessories, Bluetooth speakers, earphones, chargers, power banks, phone cases and more at JustBurgers. Best prices with fast shipping across India.', 'type' => 'string'],

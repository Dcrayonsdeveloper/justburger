...
<head>
    ...
    <title>Offline - JustBurgers</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .offline-icon svg { width: 36px; height: 36px; color: #205258; }
        h1 { font-size: 22px; font-weight: 600; color: #205258; margin-bottom: 8px; }
        p { font-size: 14px; color: #666; line-height: 1.6; margin-bottom: 24px; }
        .retry-btn {
            display: inline-flex; align-items: center; gap: 8px;
            padding: 12px 28px; background: #205258; color: #fff;
            border: none; border-radius: 30px; font-size: 14px; font-weight: 600;
            cursor: pointer; transition: background 0.2s;
        }
        .retry-btn:hover { background: #1b454a; }
...
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/offline.blade.php ENDPATH**/ ?>
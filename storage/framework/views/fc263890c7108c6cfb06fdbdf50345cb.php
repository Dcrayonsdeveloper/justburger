...
<head>
    ...
    <title>Server Error - <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?></title>
...
<body>
    <div class="header">
        <a href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="<?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>">
        </a>
    </div>
    <div class="content">
        <div class="card">
...
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/errors/500.blade.php ENDPATH**/ ?>
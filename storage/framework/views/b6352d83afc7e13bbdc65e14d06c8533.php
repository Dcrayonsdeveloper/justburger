...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Features Settings <?php $__env->endSlot(); ?>
    ...
    <!-- Settings Navigation -->
    <?php echo $__env->make('admin.settings.partials.nav', ['active' => 'product-card'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <form action="<?php echo e(route('admin.settings.product-card.update')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="max-w-2xl">
            <div class="card">
                ...
                <div class="p-5 space-y-4">
                    <!-- Quick View -->
                    <label class="flex items-center justify-between p-4 rounded-lg border border-neutral-200 cursor-pointer hover:bg-neutral-50 transition-colors" x-data="{ enabled: <?php echo e($settings['product_card_quick_view'] ? 'true' : 'false'); ?> }">
                    ...
                    <!-- Add to Cart -->
                    <label class="flex items-center justify-between p-4 rounded-lg border border-neutral-200 cursor-pointer hover:bg-neutral-50 transition-colors" x-data="{ enabled: <?php echo e($settings['product_card_add_to_cart'] ? 'true' : 'false'); ?> }">
                        <div class="flex items-center gap-3">
                    ...
                    <!-- Wishlist -->
                    <label class="flex items-center justify-between p-4 rounded-lg border border-neutral-200 cursor-pointer hover:bg-neutral-50 transition-colors" x-data="{ enabled: <?php echo e($settings['product_card_wishlist'] ? 'true' : 'false'); ?> }">
                        <div class="flex items-center gap-3">
            ...
            <div class="card mt-6">
                ...
                <div class="p-5 space-y-4">
                    <!-- Support Tickets -->
                    <label class="flex items-center justify-between p-4 rounded-lg border border-neutral-200 cursor-pointer hover:bg-neutral-50 transition-colors" x-data="{ enabled: <?php echo e($settings['support_tickets_enabled'] ? 'true' : 'false'); ?> }">
                        <div class="flex items-center gap-3">
...
<?php endif; ?>
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/admin/settings/product-card.blade.php ENDPATH**/ ?>
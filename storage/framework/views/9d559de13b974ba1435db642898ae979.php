...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(\App\Models\Setting::get('site_name', 'JustBurgers')); ?>">
    <meta name="application-name" content="<?php echo e(\App\Models\Setting::get('site_name', 'JustBurgers')); ?>">
    ...
    <link href="https://fonts.bunny.net/css?family=anton:400|barlow:400,500,600,700,800|inter:400,500,600|playfair-display:700,800,900&display=swap" rel="stylesheet" />

    <!-- Critical CSS first to prevent flash -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/critical.css']); ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo e(config('services.ga4.measurement_id')); ?>"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', '<?php echo e(config('services.ga4.measurement_id')); ?>');
    </script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.facebook.pixel_id')): ?>
    <script>
    ...
    fbq('init', '<?php echo e(config('services.facebook.pixel_id')); ?>');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=<?php echo e(config('services.facebook.pixel_id')); ?>&ev=PageView&noscript=1"
    /></noscript>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    
</head>
<body class="font-sans antialiased bg-[#111111] text-white" style="font-family: 'Barlow', sans-serif; overflow-x: clip;" x-data data-authenticated="<?php echo e(auth()->check() ? 'true' : 'false'); ?>">
    <!-- Toast Notifications -->
    ...
    <div x-show="$store.authModal.isOpen" x-cloak
        ...
        <div x-show="$store.authModal.isOpen"
            ...
            <div class="pt-6 pb-2 px-6 text-center">
                <span style="font-family:'Anton',Impact,'Arial Black',sans-serif;font-size:1.6rem;letter-spacing:2px;text-transform:uppercase;line-height:1;display:inline-block;margin-bottom:.75rem;"><span style="color:#C8102E;">JUST</span><span style="color:#111;margin-left:2px;">BURGERS</span></span>
            ...
            <div x-show="$store.authModal.mode === 'login'"
                ...
                <form @submit.prevent="$store.authModal.login(email, password, remember)" class="space-y-4">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-[#C8102E] hover:text-[#A00D24]">Forgot password?</a>
                        </div>
                        <div class="relative" x-data="{ show: false }">
                            <input :type="show ? 'text' : 'password'" x-model="password" required
                                   class="w-full px-3 py-2.5 pr-10 bg-neutral-50 border border-neutral-300 rounded-lg text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:border-[#C8102E] focus:ring-0 transition-colors"
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" x-model="remember" class="w-4 h-4 rounded border-neutral-300 text-[#C8102E] focus:ring-0">
                ...
                <p class="mt-4 text-center text-sm text-neutral-600">
                    New to <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>?
                    <button @click="$store.authModal.switchMode('register')" class="font-semibold text-[#C8102E] hover:text-[#A00D24]">Create an account</button>
                </p>
            </div>
            ...
            <div x-show="$store.authModal.mode === 'register'" x-cloak
                ...
                <p class="mt-4 text-center text-sm text-neutral-600">
                    ...
                    <button @click="$store.authModal.switchMode('login')" class="font-semibold text-[#C8102E] hover:text-[#A00D24]">Sign in</button>
                </p>
            </div>
            ...
            <div class="px-6 pb-5 pt-2 text-center">
                <p class="text-[11px] text-neutral-600 leading-relaxed">
                    By continuing, I agree to <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>'s
                    <a href="<?php echo e(route('terms')); ?>" class="text-neutral-600 underline">T&C</a>,
                    <a href="<?php echo e(route('privacy')); ?>" class="text-neutral-600 underline">Privacy Policy</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:bg-[#C8102E] focus:text-white focus:px-4 focus:py-2 focus:rounded-lg focus:text-sm focus:font-medium focus:shadow-lg">
                            ...
                            <div class="absolute bottom-3 left-3 right-3 flex gap-1.5 justify-center">
                                <template x-for="(img, i) in product.images.slice(0, 5)" :key="i">
                                    <button @click="activeImageIndex = i"
                                            ...
                                            :class="activeImageIndex === i ? 'border-[#C8102E]' : 'border-white/80'">
                    ...
                    <div class="p-5 flex flex-col">
                        ...
                        <div class="mt-auto space-y-2">
                            <template x-if="product?.in_stock">
                                <button @click="$store.toppingsModal.open(product.id, 1); close()"
                                        class="w-full py-1.5 bg-[#F8931D] hover:bg-[#E07E0A] text-white font-semibold rounded-lg text-sm transition-colors">
                                    Add to Bag
                                </button>
                            </template>
                            <a :href="product?.url"
                               class="block w-full py-1.5 text-center text-sm font-medium text-[#C8102E] rounded-lg hover:bg-[#C8102E]/5 transition-colors">
                                View Full Details
                            </a>
                        </div>
                    </div>
    ...
    <script>
        function searchBar() {
            return {
                ...
                currentPlaceholder: '',
                placeholders: [
                    'Search for Classic Burgers...',
                    'Search for Cheese Burgers...',
                    'Search for Chicken Burgers...',
                    'Search for Veggie Burgers...',
                    'Search for Loaded Fries...',
                    'Search for Milkshakes...',
                    'Search for Combo Meals...',
                    'Search for Onion Rings...',
                    'Search for Spicy Wings...',
                    'Search for Fresh Salads...',
                    'Search for Cold Drinks...',
                    'Search for BBQ Burgers...',
                    'Search for Double Patty...',
                    'Search for Kids Meals...',
                    'Search for Desserts...',
                    'Search for Wraps...',
                    'Search for Nuggets...',
                    'Search for Iced Tea...',
                    'Search for Family Packs...',
                    'Search for Meal Deals...',
                ],
                placeholderIndex: 0,
                charIndex: 0,
                isDeleting: false,
    ...
    <!-- Toppings Modal -->
    <?php if (isset($component)) { $__componentOriginalb796d8b0946588ca1019700ff76efd08 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb796d8b0946588ca1019700ff76efd08 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.toppings-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('toppings-modal'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalb796d8b0946588ca1019700ff76efd08)): ?>
<?php $attributes = $__attributesOriginalb796d8b0946588ca1019700ff76efd08; ?>
<?php unset($__attributesOriginalb796d8b0946588ca1019700ff76efd08); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb796d8b0946588ca1019700ff76efd08)): ?>
<?php $component = $__componentOriginalb796d8b0946588ca1019700ff76efd08; ?>
<?php unset($__componentOriginalb796d8b0946588ca1019700ff76efd08); ?>
<?php endif; ?>
    ...
    <div x-data x-show="$store.cart.isOpen" x-cloak
        ...
        <div x-show="$store.cart.isOpen"
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-neutral-100" style="border-top:3px solid #C8102E;">
                <h2 class="text-lg font-bold text-neutral-900 flex items-center gap-2">
                    ...
                    Your Order
                    <span class="text-sm font-normal text-neutral-400" x-text="'(' + $store.cart.count + ' item' + ($store.cart.count !== 1 ? 's' : '') + ')'"></span>
                </h2>
            ...
            <div x-show="!$store.cart.isLoading && $store.cart.items.length === 0" class="flex-1 flex flex-col items-center justify-center px-6">
                ...
                <button @click="$store.cart.close()" class="text-sm font-semibold text-[#C8102E] hover:text-[#A00D24] transition-colors">Continue Shopping</button>
            </div>
                    ...
                    <div class="flex gap-3 py-3 border-b border-neutral-100 last:border-0">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-baseline gap-1.5 mt-1">
                                ...
                                <template x-if="item.toppings_total > 0">
                                    <span class="text-[10px] text-neutral-400">(incl. toppings)</span>
                                </template>
                            </div>
                        ...
                        <div class="shrink-0 w-28 snap-start">
                            <a :href="rec.url" class="block" @click="$store.cart.close()">
                                <div class="relative aspect-square bg-neutral-50 rounded-lg overflow-hidden mb-1.5">
                                    <img :src="(rec.image && !rec.image.endsWith('.svg')) ? rec.image : '/images/products/product-' + ((rec.id % 27) + 1) + '.jpg'"
                                         :alt="rec.name" class="w-full h-full object-cover" loading="lazy">
                            ...
                            <button @click="$store.toppingsModal.open(rec.id, 1)"
                                    class="w-full mt-1.5 py-1 text-[10px] font-semibold text-[#C8102E] rounded-md hover:bg-[#C8102E] hover:text-white transition-colors">
                                Add to Bag
                            </button>
                        </div>
                    </template>
            ...
            <div x-show="$store.cart.items.length > 0" class="border-t border-neutral-200 px-5 py-4 bg-white shrink-0">
                ...
                <div class="flex flex-col gap-2">
                    <a href="<?php echo e(route('checkout.index')); ?>" @click="$store.cart.close()"
                       class="w-full py-3 bg-[#C8102E] hover:bg-[#a50e26] text-white font-bold rounded-lg text-sm text-center transition-colors">
                        Checkout
                    </a>
                    <a href="<?php echo e(route('cart.index')); ?>" @click="$store.cart.close()"
                       class="w-full py-2 text-center text-sm font-semibold text-[#C8102E] rounded-lg hover:bg-[#C8102E]/5 transition-colors">
                        View Basket
                    </a>
                </div>
            </div>
    ...
    <div x-data="pwaInstall()" x-show="showPrompt" x-cloak
        ...
        <div class="flex items-center gap-2">
            <div class="w-7 h-7 rounded bg-[#C8102E] flex items-center justify-center shrink-0">
                <svg class="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                </svg>
            </div>
            <div class="flex-1 min-w-0">
                <p class="text-[11px] font-semibold text-[#0F1111] leading-tight">Add <?php echo e(\App\Models\Setting::get('site_name', 'JustBurgers')); ?> to Home Screen</p>
            </div>
        ...
        <div class="flex gap-1.5 mt-2">
            ...
            <button @click="install()" class="flex-1 py-1 text-[10px] font-medium text-white bg-[#C8102E] rounded hover:bg-[#A00D24] transition-colors">Install</button>
        </div>
    </div>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal58c23a86edde2052917eede6c6b5323a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal58c23a86edde2052917eede6c6b5323a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.exit-intent-popup','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('exit-intent-popup'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal58c23a86edde2052917eede6c6b5323a)): ?>
<?php $attributes = $__attributesOriginal58c23a86edde2052917eede6c6b5323a; ?>
<?php unset($__attributesOriginal58c23a86edde2052917eede6c6b5323a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal58c23a86edde2052917eede6c6b5323a)): ?>
<?php $component = $__componentOriginal58c23a86edde2052917eede6c6b5323a; ?>
<?php unset($__componentOriginal58c23a86edde2052917eede6c6b5323a); ?>
<?php endif; ?>
</body>
</html>
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/components/layouts/app.blade.php ENDPATH**/ ?>
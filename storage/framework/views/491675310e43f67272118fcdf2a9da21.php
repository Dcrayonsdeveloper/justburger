...
<nav <?php echo e($attributes->merge(['class' => 'text-[16px]'])); ?> aria-label="Breadcrumb">
    <ol class="flex items-center flex-wrap gap-1.5" itemscope itemtype="https://schema.org/BreadcrumbList">
        <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
            <a href="<?php echo e(url('/')); ?>" itemprop="item" class="inline-flex items-center gap-1 text-neutral-600 hover:text-primary-600 transition-colors">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <li class="flex items-center gap-1.5" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->last): ?>
                    <span itemprop="name" class="text-neutral-800 font-medium"><?php echo e($item['label']); ?></span>
                <?php else: ?>
                    <a href="<?php echo e($item['url']); ?>" itemprop="item" class="text-neutral-600 hover:text-primary-600 transition-colors">
...
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/components/breadcrumb.blade.php ENDPATH**/ ?>
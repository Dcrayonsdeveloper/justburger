...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> <?php echo e($siteSettings['site_name']); ?> - <?php echo e($siteSettings['site_tagline']); ?> <?php $__env->endSlot(); ?>

    <?php $__env->startPush('meta'); ?>
        <meta name="description" content="<?php echo e($siteSettings['site_tagline']); ?> — Charbroiled burgers, chicken burgers, kebab wraps, milkshakes and more. <?php echo e(\App\Models\Setting::get('site_address', '525 Staines Road, Bedfont, Middx. TW14 8BP')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siteSettings['site_logo']): ?>
        <meta property="og:image" content="<?php echo e(asset('images/' . $siteSettings['site_logo'])); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($flashSale): ?>
    <div x-data="flashSalePopup(<?php echo e($flashSale->remaining_time); ?>,'<?php echo e($flashSale->slug); ?>')"
        ...
        <div x-show="open"
            ...
            <div class="bg-gradient-to-br from-[#C8102E] to-[#8B0A1D] px-6 pt-8 pb-6 text-center">
                ...
                <h2 class="jbp-h text-3xl text-white mb-4"><?php echo e($flashSale->name); ?></h2>
    ...
    <section style="background: #1a0e08;" x-data="{
        cur: 0, total: <?php echo e(max($banners->count(), 1)); ?>, tm: null, paused: false,
    ...
    @touchstart.passive="tstart($event)" @touchmove="tmove($event)" @touchend.passive="tend($event)">
        <div class="hero-wrap">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php $tag = $heroTagPalette[$idx % count($heroTagPalette)]; ?>
                <div class="hero-slide"
                     x-show="cur === <?php echo e($idx); ?>"
                     x-transition:enter="transition-opacity ease-out duration-700"
                     x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                     x-transition:leave="transition-opacity ease-in duration-500"
                     x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                    <div class="hero-bg" style="background-image: url('<?php echo e($bannerImg($banner->image_url)); ?>');"></div>
                    <div class="hero-grad"></div>
                    <div class="hero-body">
                        <div class="hero-inner">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($banner->name): ?>
                                <span class="hero-tag" style="background: <?php echo e($tag['bg']); ?>; color: <?php echo e($tag['fg']); ?>;"><?php echo e($banner->name); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <h<?php echo e($idx === 0 ? '1' : '2'); ?> class="jbp-h hero-title"><?php echo nl2br(e($banner->title)); ?></h<?php echo e($idx === 0 ? '1' : '2'); ?>>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($banner->subtitle): ?>
                                <p class="hero-sub"><?php echo e($banner->subtitle); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($banner->button_text): ?>
                                <a href="<?php echo e($banner->link ?: route('products.index')); ?>" class="hero-cta">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <div class="hero-slide">
                    <div class="hero-bg" style="background-image: url('<?php echo e(asset('images/products/justburgers/monster-burger.jpg')); ?>');"></div>
                    <div class="hero-grad"></div>
                    <div class="hero-body">
                        <div class="hero-inner">
    ...
    <section class="op-panel jb-reveal">
        <div class="op-grid">
            ...
            <div class="op-col">
                ...
                <a href="tel:<?php echo e(\App\Models\Setting::get('site_phone','02088905008')); ?>" class="op-btn">
            ...
            <div class="op-col op-col--wa">
                ...
                <a href="https://wa.me/<?php echo e(\App\Models\Setting::get('whatsapp_number','447368998035')); ?>?text=<?php echo e(urlencode('Hi! I\'d like to place an order please.')); ?>"
            ...
            <div class="op-col">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="op-btn">
                    View Our Menu
    ...
    <?php $ld = $sections->get('lunchtime_deal'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ld): ?>
    <div class="ld-wrap jb-reveal">
        <div class="ld-inner">

            
            <div class="ld-text">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($ld->content['tag'])): ?>
                    <span class="ld-tag"><?php echo e($ld->content['tag']); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <h2 class="jbp-h ld-title"><?php echo nl2br(e($ld->title)); ?></h2>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ld->subtitle): ?>
                    <p style="color:rgba(255,255,255,.35);font-size:.95rem;margin-bottom:.4rem;font-weight:500;"><?php echo e($ld->subtitle); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($ld->content['price'])): ?>
                    <div class="ld-price" x-data="priceReveal('<?php echo e($ld->content['price']); ?>')" x-intersect:enter.once="animate()" x-text="display"><?php echo e($ld->content['price']); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($ld->content['note'])): ?>
                    <p class="ld-note"><?php echo e($ld->content['note']); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="ld-btns">
                    <a href="<?php echo e($ld->button_link ?: route('products.index')); ?>" class="ld-btn-p">
                        <?php echo e($ld->button_text ?: 'Order Now'); ?>
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" class="ld-btn-s">View Menu</a>
                </div>
            </div>

            
            <div class="ld-illus">
                <img src="<?php echo e($bannerImg($ld->image_url)); ?>" alt="<?php echo e($ld->title); ?>"
    ...
    <section class="ps-section jb-reveal" x-data="sliderNav($refs.fpTrack, <?php echo e($featuredProducts->count()); ?>)">
        <div class="ps-head">
            <div class="ps-head-text">
                <p class="ps-eyebrow">Fan Favourites</p>
                <h2 class="jbp-h ps-title">Popular Items</h2>
            </div>
            <a href="<?php echo e(route('products.index')); ?>" class="ps-view-all">
                View All
                <svg width="11" height="11" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
            </a>
        </div>
...
<?php endif; ?>
    ...
    <?php $menuHead = $sections->get('menu_head'); ?>
    <section class="menu-section jb-reveal">
        <div style="max-width:72rem;margin:0 auto;padding:0 1.5rem;">
            <div class="menu-section-head">
                <p class="menu-eyebrow"><?php echo e($menuHead?->subtitle ?: 'What We Do Best'); ?></p>
                <h2 class="jbp-h menu-title"><?php echo e($menuHead?->title ?: 'Our Menu'); ?></h2>
            </div>
            ...
            ?>
            <div class="cat-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $carouselCategories->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('products.index', ['category' => $category->slug])); ?>"
                       class="cat-tile cat-<?php echo e($catPalette[$idx % count($catPalette)]); ?>">
                        <span class="cat-emoji"><?php echo e($pickEmoji($category->name)); ?></span>
                        <div class="cat-info">
                            <p class="cat-name"><?php echo e($category->name); ?></p>
                            <p class="cat-price"><?php echo e($category->products_count); ?> <?php echo e(Str::plural('item', $category->products_count)); ?></p>
                        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <a href="<?php echo e(route('products.index')); ?>" class="cat-tile cat-red">
            ...
            <div class="menu-cta">
                <a href="<?php echo e($menuHead?->button_link ?: route('products.index')); ?>" class="menu-cta-btn">
                    <?php echo e($menuHead?->button_text ?: 'View Full Menu'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bestsellers->count()): ?>
    <section class="ps-section ps-section--dark jb-reveal" x-data="sliderNav($refs.bsTrack, <?php echo e($bestsellers->count()); ?>)">
        <div class="ps-head">
            <div class="ps-head-text">
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deals->count()): ?>
    <section class="ps-section jb-reveal" x-data="sliderNav($refs.dlTrack, <?php echo e($deals->count()); ?>)">
        <div class="ps-head">
            <div class="ps-head-text">
        ...
        <div class="ps-wrap">
            ...
            <div class="ps-track" x-ref="dlTrack" @scroll.passive="onScroll()">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginal3fd2897c1d6a149cdb97b41db9ff827a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3fd2897c1d6a149cdb97b41db9ff827a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.product-card','data' => ['product' => $product,'compact' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('product-card'); ?>
...
<?php endif; ?>
    ...
    ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoSpec || $promoLoc): ?>
    <section class="pc-section jb-reveal">
        <div class="pc-grid">

            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoSpec): ?>
            <a href="<?php echo e($promoSpec->button_link ?: route('products.index')); ?>" class="pc-card">
                <div class="pc-bg" style="background-image: url('<?php echo e($bannerImg($promoSpec->image_url)); ?>');"></div>
                <div class="pc-overlay" style="background: linear-gradient(160deg, rgba(120,6,22,.88) 0%, rgba(10,4,2,.6) 100%);"></div>
                <div class="pc-body">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($promoSpec->content['eyebrow'])): ?>
                        <p class="pc-eyebrow" style="color: rgba(255,200,180,.65);"><?php echo e($promoSpec->content['eyebrow']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <h3 class="jbp-h pc-title"><?php echo nl2br(e($promoSpec->title)); ?></h3>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoSpec->subtitle): ?>
                        <p class="pc-desc" style="color: rgba(255,255,255,.6);"><?php echo e($promoSpec->subtitle); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoSpec->button_text): ?>
                    <span class="pc-link">
                        <?php echo e($promoSpec->button_text); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoLoc): ?>
            <a href="<?php echo e($promoLoc->button_link ?: url('/contact')); ?>" class="pc-card">
                <div class="pc-bg" style="background-image: url('<?php echo e($bannerImg($promoLoc->image_url)); ?>'); background-position: center top;"></div>
                <div class="pc-overlay" style="background: linear-gradient(to top, rgba(6,3,2,.95) 0%, rgba(6,3,2,.55) 55%, rgba(6,3,2,.15) 100%);"></div>
                <div class="pc-body">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($promoLoc->content['eyebrow'])): ?>
                        <p class="pc-eyebrow" style="color: #C8102E;"><?php echo e($promoLoc->content['eyebrow']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <h3 class="jbp-h pc-title"><?php echo nl2br(e($promoLoc->title)); ?></h3>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoLoc->subtitle): ?>
                        <p class="pc-desc" style="color: rgba(255,255,255,.5);"><?php echo e($promoLoc->subtitle); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($promoLoc->button_text): ?>
                    <span class="pc-link">
                        <?php echo e($promoLoc->button_text); ?>
    ...
    <section class="tm-section jb-reveal" x-data="{ tmCur: 0, tmTotal: <?php echo e($testimonials->count()); ?>, tmScroll(el) { const cards = el.children; if(!cards.length) return; const sl = el.scrollLeft; const cw = cards[0].offsetWidth + 16; this.tmCur = Math.round(sl / cw); } }">
        <div class="tm-head">
        ...
        <div class="tm-grid" x-ref="tmGrid" @scroll.passive="tmScroll($refs.tmGrid)">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="tm-card">
                    <div class="tm-stars">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <svg width="14" height="14" viewBox="0 0 20 20"
                                 fill="<?php echo e($i <= ($testimonial->rating ?? 5) ? '#D4A017' : 'rgba(255,255,255,.15)'); ?>">
                    ...
                    <p class="tm-quote">&ldquo;<?php echo e($testimonial->content); ?>&rdquo;</p>
                    <div class="tm-person">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->avatar_url): ?>
                            <img src="<?php echo e($testimonial->avatar_url); ?>" alt="<?php echo e($testimonial->name); ?>"
                                 class="tm-avatar" style="object-fit:cover;">
                        <?php else: ?>
                            <div class="tm-avatar"><?php echo e(strtoupper(substr($testimonial->name, 0, 1))); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div>
                            <p class="tm-author"><?php echo e($testimonial->name); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->title): ?>
                                <p class="tm-role"><?php echo e($testimonial->title); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <?php $todayDow = (int) now('Europe/London')->format('N'); ?>
    <section class="hours-section jb-reveal">
        <div class="hours-inner">
            <div class="hours-head">
                <p class="hours-eyebrow"><?php echo e(\App\Models\Setting::get('site_address', '525 Staines Road, Bedfont, Middx. TW14 8BP')); ?></p>
                <h3 class="jbp-h hours-title">Opening Hours</h3>
            </div>
            <div class="hours-grid">
                <div class="hours-item <?php echo e(in_array($todayDow, [1,2]) ? 'hours-item--today' : ''); ?>">
                    <p class="hours-item-day">Mon &amp; Tue</p>
                    <p class="hours-item-time"><?php echo e(\App\Models\Setting::get('hours_monday', '12:00 – 9:00 PM')); ?></p>
                </div>
                <div class="hours-item <?php echo e(in_array($todayDow, [3,4]) ? 'hours-item--today' : ''); ?>">
                    <p class="hours-item-day">Wed &amp; Thu</p>
                    <p class="hours-item-time"><?php echo e(\App\Models\Setting::get('hours_wednesday', '12:00 – 10:00 PM')); ?></p>
                </div>
                <div class="hours-item <?php echo e(in_array($todayDow, [5,6]) ? 'hours-item--today' : ''); ?>">
                    <p class="hours-item-day">Fri &amp; Sat</p>
                    <p class="hours-item-time"><?php echo e(\App\Models\Setting::get('hours_friday', '12:00 – 11:00 PM')); ?></p>
                </div>
                <div class="hours-item <?php echo e($todayDow === 7 ? 'hours-item--today' : ''); ?>">
                    <p class="hours-item-day">Sunday</p>
                    <p class="hours-item-time"><?php echo e(\App\Models\Setting::get('hours_sunday', '4:00 – 10:00 PM')); ?></p>
                </div>
            </div>
            <div style="flex-shrink:0;">
                <a href="<?php echo e(url('/contact')); ?>" class="hours-cta-btn">
                    Find Us
                    <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
                </a>
            </div>
    ...
    <?php $story = $sections->get('our_story'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($story): ?>
    <section class="story-section jb-reveal">
        <div class="story-bg" style="background-image: url('<?php echo e($bannerImg($story->image_url)); ?>');"></div>
        <div class="story-overlay"></div>
        <div class="story-body">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($story->content['eyebrow'])): ?>
                <p class="story-eyebrow"><?php echo e($story->content['eyebrow']); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <h2 class="jbp-h story-title"><?php echo nl2br(e($story->title)); ?></h2>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($story->subtitle): ?>
                <p class="story-text"><?php echo e($story->subtitle); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($story->button_text): ?>
            <a href="<?php echo e($story->button_link ?: url('/about')); ?>" class="story-cta">
    ...
    <?php $newsletter = $sections->get('newsletter'); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newsletter === null || $newsletter->is_active): ?>
    <section class="nl-section jb-reveal"
             x-data="{ email:'', loading:false, done:false, err:'' }">
        <div class="nl-inner">
            <p class="nl-eyebrow"><?php echo e($newsletter?->content['eyebrow'] ?? 'Stay In The Loop'); ?></p>
            <h2 class="jbp-h nl-title"><?php echo e($newsletter?->title ?: 'Get Exclusive Offers'); ?></h2>
            <p class="nl-text"><?php echo e($newsletter?->subtitle ?: 'Join our list for lunchtime deal alerts, seasonal specials and first dibs on new menu drops. No spam — ever.'); ?></p>
            ...
            <form class="nl-form"
                ...
                <button type="submit" class="nl-btn" :disabled="loading || done"
                        x-text="loading ? 'Joining...' : (done ? '✓ Joined' : '<?php echo e($newsletter?->button_text ?: 'Sign Me Up'); ?>')"></button>
            </form>
...
<?php endif; ?>
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/home.blade.php ENDPATH**/ ?>
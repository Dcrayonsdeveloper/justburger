    ...
    <div class="flex overflow-x-auto scrollbar-thin">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <a href="<?php echo e(route($tab['route'])); ?>"
               class="flex items-center gap-1.5 px-4 py-3 text-sm font-medium whitespace-nowrap border-b-2 transition-colors <?php echo e(($active ?? '') === $key ? 'text-neutral-900 border-neutral-900' : 'text-neutral-800 border-transparent hover:text-neutral-900 hover:border-neutral-400'); ?>">
                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><?php echo $tab['icon']; ?></svg>
...
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/admin/settings/partials/nav.blade.php ENDPATH**/ ?>
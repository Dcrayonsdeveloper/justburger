...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Delivery Information - <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?> <?php $__env->endSlot(); ?>

    <?php $__env->startPush('meta'); ?>
        <meta name="description" content="Delivery and collection information for <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>. Order by phone, WhatsApp, or online from our Feltham takeaway.">
        <link rel="canonical" href="<?php echo e(url('/shipping')); ?>">
    <?php $__env->stopPush(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['items' => [['label' => 'Delivery Info', 'url' => null]]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([['label' => 'Delivery Info', 'url' => null]])]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8 sm:mb-10">
                ...
                <p class="text-[16px] text-neutral-600">How to get your food from <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>.</p>
            </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="tel:<?php echo e(\App\Models\Setting::get('site_phone', '02088905008')); ?>" class="text-sm font-bold text-[#C8102E] mt-1.5 block"><?php echo e(\App\Models\Setting::get('site_phone', '020 8890 5008')); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/<?php echo e(\App\Models\Setting::get('whatsapp_number', '447368998035')); ?>" target="_blank" class="text-sm font-bold text-green-600 mt-1.5 block"><?php echo e(\App\Models\Setting::get('site_mobile', '07368 998 035')); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('products.index')); ?>" class="text-sm font-bold text-blue-600 mt-1.5 block">View Menu</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold text-amber-600 mt-1.5"><?php echo e(\App\Models\Setting::get('site_address', '525 Staines Road, Bedfont')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div x-data="{ open: null }" class="space-y-3">
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 1" x-collapse>
                        <div class="px-5 pb-4 text-[16px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">Place your order by phone, WhatsApp, or online. We'll prepare it fresh and let you know when it's ready. Just pop in and collect from our shop at <?php echo e(\App\Models\Setting::get('site_address', '525 Staines Road, Bedfont, TW14 8BP')); ?>.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 5" x-collapse>
                        <div class="px-5 pb-4 text-[16px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">If anything isn't right with your order, please let us know straight away. Call us on <?php echo e(\App\Models\Setting::get('site_phone', '020 8890 5008')); ?> or WhatsApp <?php echo e(\App\Models\Setting::get('site_mobile', '07368 998 035')); ?> and we'll sort it out for you.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/pages/shipping.blade.php ENDPATH**/ ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Support Tickets <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="flex items-center gap-0 px-4" style="border-bottom:1px solid #e1e1e1">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(route('admin.support-tickets.index', array_merge(request()->except('status', 'page'), $value ? ['status' => $value] : []))); ?>"
                   class="relative px-4 py-3 text-sm font-medium transition-colors
                    ...
                    <?php elseif($value === 'open' && isset($stats['open']) && $stats['open'] > 0): ?>
                        <span class="ml-1 text-xs text-gray-400"><?php echo e($stats['open']); ?></span>
                    <?php elseif($value === 'in_progress' && isset($stats['answered']) && $stats['answered'] > 0): ?>
                        <span class="ml-1 text-xs text-gray-400"><?php echo e($stats['answered']); ?></span>
                    <?php elseif($value === 'closed' && isset($stats['closed']) && $stats['closed'] > 0): ?>
                        <span class="ml-1 text-xs text-gray-400"><?php echo e($stats['closed']); ?></span>
        ...
        <div class="px-4 py-3" style="border-bottom:1px solid #e1e1e1">
            <form action="<?php echo e(route('admin.support-tickets.index')); ?>" method="GET" class="flex items-center gap-3">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search')): ?>
                    <a href="<?php echo e(route('admin.support-tickets.index', request('status') ? ['status' => request('status')] : [])); ?>"
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-gray-50 cursor-pointer group" style="border-bottom:1px solid #e1e1e1"
                            onclick="window.location='<?php echo e(route('admin.support-tickets.show', $ticket)); ?>'">
                            ...
                            <td class="px-4 py-3">
                                <div>
                                    <p class="font-medium text-gray-900"><?php echo e($ticket->user->full_name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($ticket->user->email); ?></p>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-gray-700">
                                <?php echo e(Str::limit($ticket->subject, 40)); ?>
...
<?php endif; ?>
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/admin/support-tickets/index.blade.php ENDPATH**/ ?>
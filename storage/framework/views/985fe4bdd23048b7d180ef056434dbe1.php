...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
     ...
     <?php $__env->slot('title', null, []); ?> Marketing Hub <?php $__env->endSlot(); ?>
    ...
    <div class="space-y-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div class="bg-green-50 border border-green-200 text-green-800 text-sm px-4 py-3 rounded-lg"><?php echo e(session('success')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
            <div class="bg-red-50 border border-red-200 text-red-800 text-sm px-4 py-3 rounded-lg"><?php echo e(session('error')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden">
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-neutral-100">
                ...
                <div class="flex items-center gap-2 shrink-0 ml-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connections['facebook']['connected'] || $connections['instagram']['connected']): ?>
                        <form action="<?php echo e(route('admin.marketing.meta.disconnect')); ?>" method="POST" onsubmit="return confirm('Disconnect all Meta accounts?')">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <a href="<?php echo e(route('admin.marketing.meta.redirect')); ?>"
                       class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white rounded-lg transition-colors" style="background:#1877F2">
                        ...
                        <?php echo e(($connections['facebook']['connected']) ? 'Reconnect' : 'Connect'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-neutral-100">
                ...
                <div class="p-5">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connections['facebook']['connected']): ?>
                        ...
                        <p class="text-xs text-neutral-400"><?php echo e($connections['facebook']['page_id']); ?></p>
                    <?php else: ?>
                ...
                <div class="p-5">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connections['instagram']['connected']): ?>
                        <div class="flex items-center gap-1.5 mb-2">
                            <span class="w-2 h-2 rounded-full" style="background:#22c55e"></span>
                            <span class="text-xs font-medium" style="color:#22c55e">Active</span>
                        </div>
                        <p class="text-xs text-neutral-400"><?php echo e($connections['instagram']['user_id']); ?></p>
                    <?php else: ?>
                        <p class="text-xs text-neutral-400 italic">Not connected</p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <div class="p-5">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connections['whatsapp']['connected']): ?>
                        <div class="flex items-center gap-1.5 mb-2">
                            <span class="w-2 h-2 rounded-full" style="background:#22c55e"></span>
                            <span class="text-xs font-medium" style="color:#22c55e">Active</span>
                        </div>
                        <p class="text-xs text-neutral-400"><?php echo e($connections['whatsapp']['phone_id']); ?></p>
                    <?php else: ?>
                        <p class="text-xs text-neutral-400 italic">Not connected</p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-5 border-b border-neutral-100">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connections['ads']['connected']): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connections['ads']['connected']): ?>
                    <div class="grid grid-cols-3 gap-6">
                        <div>
                            ...
                            <p class="text-sm font-medium text-neutral-900"><?php echo e($connections['ads']['account_name']); ?></p>
                        </div>
                        <div>
                            <p class="text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-1">Account ID</p>
                            <p class="text-sm text-neutral-600"><?php echo e($connections['ads']['account_id']); ?></p>
                        </div>
                        <div>
        ...
        <div class="bg-white rounded-xl border border-neutral-200 overflow-hidden">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 divide-x divide-neutral-100">
                <a href="<?php echo e(route('admin.coupons.index')); ?>" class="flex flex-col items-center gap-2 p-5 hover:bg-neutral-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.banners.index')); ?>" class="flex flex-col items-center gap-2 p-5 hover:bg-neutral-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.flash-sales.index')); ?>" class="flex flex-col items-center gap-2 p-5 hover:bg-neutral-50 transition-colors text-center">
                ...
                <a href="<?php echo e(route('admin.newsletter.index')); ?>" class="flex flex-col items-center gap-2 p-5 hover:bg-neutral-50 transition-colors text-center">
        ...
        <div class="bg-neutral-50 rounded-xl border border-neutral-200 p-5">
            ...
            <div class="text-xs text-neutral-500 space-y-1">
                ...
                <p><span class="font-medium">OAuth Redirect URI:</span> <?php echo e(route('admin.marketing.meta.callback')); ?></p>
                <p><span class="font-medium">Webhook URL:</span> <?php echo e(url('/api/webhook/meta')); ?></p>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/admin/marketing/hub.blade.php ENDPATH**/ ?>
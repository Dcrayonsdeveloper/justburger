...
<head>
    ...
    <title>Login - <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?></title>
...
<div class="auth-wrapper"
     x-data="{
        mode: '<?php echo e($errors->has('full_name') || $errors->has('phone') || $errors->has('terms') || old('_register') || request()->get('mode') === 'register' ? 'register' : 'login'); ?>'
     }">
    ...
    <div x-show="mode === 'login'" x-cloak:remove>
        <div class="auth-card" x-data="unifiedLogin()">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                <div class="auth-success"><?php echo e(session('success')); ?></div>
            ...
            <div x-show="step === 'password'" x-cloak style="display:flex;flex-direction:column;gap:1rem;">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" style="display:flex;flex-direction:column;gap:1rem;">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="email" :value="identifier">
                    <div>
                        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:.4rem;">
                            <label class="auth-label" style="margin:0;">Password</label>
                            <a href="<?php echo e(route('password.request')); ?>" class="auth-link">Forgot?</a>
                        </div>
        ...
        <div class="auth-social-row">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.google.client_id')): ?>
            <a href="<?php echo e(route('social.redirect', 'google')); ?>" class="auth-social-btn">
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <a href="<?php echo e(route('social.redirect', 'facebook')); ?>" class="auth-social-btn">
        ...
        <!-- Switch to register -->
        <div class="auth-divider"><span>New to <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>?</span></div>
        ...
        <div style="text-align:center;margin-top:1.5rem;">
            <a href="<?php echo e(url('/')); ?>" class="auth-back-link">
                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg>
                Back to <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>
    ...
    <div x-show="mode === 'register'" x-cloak>
        <div class="auth-card">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" style="display:flex;flex-direction:column;gap:.75rem;">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="_register" value="1">

                <div>
                    <label for="full_name" class="auth-label">Your name</label>
                    <input type="text" name="full_name" id="full_name" value="<?php echo e(old('full_name')); ?>" required autocomplete="name"
                           class="auth-input <?php $__errorArgs = ['full_name'];
...
unset($__errorArgs, $__bag); ?>" placeholder="First and last name">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" autocomplete="tel"
                           class="auth-input <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> auth-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="reg_email" value="<?php echo e(old('_register') ? old('email') : ''); ?>" required autocomplete="email"
                           class="auth-input <?php if(old('_register')): ?> <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> auth-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <?php endif; ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(old('_register')): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="password" name="password" id="reg_password" required autocomplete="new-password"
                           class="auth-input <?php if(old('_register')): ?> <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> auth-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <p class="auth-terms">
                By creating an account, you agree to <?php echo e(\App\Models\Setting::get('site_name', config('app.name'))); ?>'s
                <a href="<?php echo e(route('terms')); ?>">Conditions of Use</a>
                and
                <a href="<?php echo e(route('privacy')); ?>">Privacy Notice</a>.
            </p>
        </div>
...
function unifiedLogin() {
    return {
        ...
        async sendOtpForIdentifier() {
            ...
            try {
                const r = await fetch('<?php echo e(route("otp.send-login")); ?>', {
                    method: 'POST',
        ...
        async verifyOtp() {
            ...
            try {
                const r = await fetch('<?php echo e(route("otp.verify-login")); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content, 'Accept': 'application/json' },
...
function otpReset() {
    return {
        ...
        async sendOtp() {
            ...
            try {
                const r = await fetch('<?php echo e(route("otp.send-reset")); ?>', {
                    method: 'POST',
        ...
        async verifyOtp() {
            ...
            this.verifying = true; this.error = '';
            try {
                const r = await fetch('<?php echo e(route("otp.verify-reset")); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content },
                    body: JSON.stringify({ identifier: this.identifier, otp: this.otp })
                });
        ...
        async resetPassword() {
            ...
            try {
                const r = await fetch('<?php echo e(route("otp.reset-password")); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content, 'Accept': 'application/json' },
...
<?php /**PATH /home/u322703740/domains/justburger.dcrayons.app/resources/views/auth/login.blade.php ENDPATH**/ ?>
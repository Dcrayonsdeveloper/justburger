<x-layouts.app>
    <x-slot name="title">Order Confirmed - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="robots" content="noindex, nofollow">
        <meta property="og:title" content="Order Confirmed - {{ \App\Models\Setting::get('site_name', config('app.name')) }}">
            ...
            <div class="max-w-2xl mx-auto">
                        ...
                        @foreach($order->items as $item)
                            <div class="flex gap-3.5 p-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-[16px] font-semibold text-neutral-900 truncate">{{ $item->product_name }}</p>
                                ...
                                <div class="text-right shrink-0">
                                    <p class="text-[16px] font-semibold text-neutral-900">@price($item->total)</p>
                                    @if($item->quantity > 1)
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="bg-white rounded-xl border border-neutral-100 p-4">
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <h3 class="text-[16px] font-semibold text-neutral-900">Payment</h3>
                        </div>
                ...
                @if($order->discount > 0)
                    ...
                    <div class="bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3 mb-4 flex items-center gap-2.5">
                        ...
                        <p class="text-[16px] font-medium text-emerald-800">

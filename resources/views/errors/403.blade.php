...
<head>
    ...
    <title>Access Denied - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</title>
...
<body>
    <div class="header">
        <a href="{{ url('/') }}">
            <img src="{{ asset('images/logo.svg') }}" alt="{{ \App\Models\Setting::get('site_name', config('app.name')) }}">
        </a>
    </div>
    <div class="content">
        <div class="card">
            ...
            <p class="message">{{ $exception->getMessage() ?: 'You do not have permission to access this page. Please log in or contact support if you believe this is an error.' }}</p>
            <div class="actions">

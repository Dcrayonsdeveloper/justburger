<x-layouts.app>
    <x-slot name="title">{{ $query ? 'Search: ' . $query : 'Search' }} - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="robots" content="noindex, follow">
        <meta name="description" content="Search results for '{{ e($query ?? '') }}' at {{ \App\Models\Setting::get('site_name', config('app.name')) }}.">
    @endpush

...
<head>
    ...
    @unless(View::hasSection('meta'))
        <meta name="description" content="{{ \App\Models\Setting::get('site_name', config('app.name')) }} - Order fresh, flame-grilled burgers, sides, and drinks online.">
        ...
        <meta property="og:description" content="Order fresh, flame-grilled burgers, sides, and drinks at {{ \App\Models\Setting::get('site_name', config('app.name')) }}.">
        ...
        <meta name="twitter:title" content="@yield('title', \App\Models\Setting::get('site_name', config('app.name')))">
        <meta name="twitter:description" content="Order fresh, flame-grilled burgers, sides, and drinks at {{ \App\Models\Setting::get('site_name', config('app.name')) }}.">
    ...
    <link href="https://fonts.bunny.net/css?family=barlow:400,500,600,700,800|inter:400,500,600&display=swap" rel="stylesheet" />
...
<body class="font-sans antialiased bg-[#faf7f5] text-[#1a1a1a]" style="font-family: 'Barlow', sans-serif;" x-data>
    <!-- Toast Notifications -->
    ...
    <div x-data="pwaInstall()" x-show="showPrompt" x-cloak
        ...
        <div class="flex items-start gap-3">
            <div class="w-11 h-11 rounded-xl bg-[#C8102E] flex items-center justify-center shrink-0">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                </svg>
            </div>
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-neutral-900">Add {{ \App\Models\Setting::get('site_name', 'JustBurgers') }} to Home Screen</p>
        ...
        <div class="flex gap-2 mt-3">
            ...
            <button @click="install()" class="flex-1 py-2 text-xs font-medium text-white bg-[#C8102E] rounded-xl hover:bg-[#A00D24] transition-colors">Install App</button>
        </div>
    </div>

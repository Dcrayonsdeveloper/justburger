...
<head>
    ...
    <title>Reset Password - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</title>
    ...
    <div class="h-screen flex overflow-hidden">
            ...
            <div class="w-full max-w-md mx-auto form-enter">
                ...
                <div class="mb-6">
                    <a href="{{ url('/') }}" class="inline-block">
                        <img src="{{ asset('images/logo.svg') }}" alt="{{ \App\Models\Setting::get('site_name', config('app.name')) }}" class="h-12 lg:h-14 object-contain">
                    </a>
                </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center"
            ...
            <div class="absolute bottom-10 right-10 z-20">
                <p class="text-white/40 text-xs tracking-widest uppercase">{{ \App\Models\Setting::get('site_name', config('app.name')) }}</p>
            </div>
        </div>

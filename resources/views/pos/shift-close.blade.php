<x-pos.layout>
<div class="pos-container" x-data="shiftClose()" @keydown.enter="closeShift()">
    <div class="flex items-center justify-center h-full pos-scroll" style="background: linear-gradient(135deg, #F8FAFC 0%, #E2E8F0 100%); padding: 2rem;">
        <div class="pos-card w-full max-w-lg pos-fade-in" style="box-shadow: 0 8px 32px rgba(0,0,0,0.08);">

            {{-- Header --}}
            <div class="px-6 py-4 flex items-center justify-between" style="border-bottom: 1px solid var(--pos-border);">
                <div>
            ...
            <div class="px-6 py-4 space-y-4">
                ...
                <div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex justify-between text-sm">
                            <span style="color: var(--pos-text-muted);">Tax (VAT)</span>

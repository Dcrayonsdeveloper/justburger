...
<div class="pos-container" x-data="posReports()" x-init="init()">
    ...
    {{-- ═══════ HEADER ═══════ --}}
    <div class="flex items-center justify-between px-6 py-3" style="background: var(--pos-sidebar); color: white;">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-base font-semibold">Reports & Analytics</h1>
        </div>
        <div class="flex items-center gap-3">
            <input type="date" x-model="dateFrom" @change="loadAll()" class="px-3 py-1.5 rounded text-sm" style="background: rgba(255,255,255,0.1); color: white; border: 1px solid rgba(255,255,255,0.15);">
            <span class="text-xs" style="color: #CBD5E1;">to</span>
            <input type="date" x-model="dateTo" @change="loadAll()" class="px-3 py-1.5 rounded text-sm" style="background: rgba(255,255,255,0.1); color: white; border: 1px solid rgba(255,255,255,0.15);">
    ...
    {{-- ═══════ CONTENT ═══════ --}}
    <div class="flex-1 pos-scroll p-6 space-y-6" style="background: #F1F5F9;">
...
function posReports() {
    return {
        ...
        formatNum(n) {
            return (n || 0).toLocaleString('en-GB', { maximumFractionDigits: 2 });
        },

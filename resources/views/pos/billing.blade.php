            ...
            <div x-show="showSearchResults && searchResults.length > 0" x-transition
                ...
                <template x-for="product in searchResults" :key="product.id">
                    <button @click="addToCart(product); showSearchResults = false; searchQuery = ''; searchResults = [];"
                        ...
                        <img :src="product.image || '{{ asset('images/no-product-image.jpg') }}'" class="w-10 h-10 rounded-lg object-cover" style="border: 1px solid #E2E8F0;" onerror="this.src='{{ asset('images/no-product-image.jpg') }}'">
                    ...
                    <template x-for="product in products" :key="product.id">
                        <button @click="addToCart(product)"
                            ...
                            <div class="relative mb-2 rounded-lg overflow-hidden" style="aspect-ratio: 1; background: #F8FAFC;">
                                <img :src="product.image || '{{ asset('images/no-product-image.jpg') }}'"
                                     class="w-full h-full object-cover"
                                     x-on:error="$el.src='{{ asset('images/no-product-image.jpg') }}'"
                                     loading="lazy">
                                {{-- Stock badge --}}

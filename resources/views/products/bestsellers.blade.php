<x-layouts.app>
    <x-slot name="title">Bestsellers - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Shop our bestselling products at {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Top-rated items loved by customers.">
        <link rel="canonical" href="{{ url('/products/bestsellers') }}">
        <meta property="og:title" content="Bestsellers - {{ \App\Models\Setting::get('site_name', config('app.name')) }}">
        <meta property="og:description" content="Shop our bestselling products at {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Top-rated items loved by customers.">
        <meta property="og:type" content="website">
        <meta property="og:url" content="{{ url('/products/bestsellers') }}">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:title" content="Bestsellers - {{ \App\Models\Setting::get('site_name', config('app.name')) }}">
    @endpush

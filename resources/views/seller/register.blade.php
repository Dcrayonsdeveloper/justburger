...
<head>
    ...
    <title>Become a Seller - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</title>
...
<body class="font-sans antialiased bg-gradient-to-br from-primary-600 to-primary-800">
    <div class="min-h-screen flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-primary-200">Start selling on {{ \App\Models\Setting::get('site_name', config('app.name')) }}</p>
        </div>

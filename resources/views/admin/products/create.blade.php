                        ...
                        <div class="px-5 pb-5">
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500 text-sm">£</span>
                                        <input type="number" name="large_price" id="large_price" value="{{ old('large_price') }}"
                                               step="0.01" min="0"
                            ...
                            @foreach($groupToppings as $topping)
                                <div class="flex items-center gap-3 py-1">
                                    ...
                                    <label class="flex items-center gap-1.5 cursor-pointer text-xs text-neutral-500">
                                        <input type="checkbox" name="default_toppings[]" value="{{ $topping->id }}"
                                               {{ in_array($topping->id, old('default_toppings', [])) ? 'checked' : '' }}
                                               class="form-checkbox">
                                        Default
                                    </label>
                                </div>

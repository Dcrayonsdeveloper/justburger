<x-layouts.admin>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-neutral-600 mb-1">
            ...
            <span class="text-neutral-900">Edit: {{ $banner->name }}</span>
        </div>
        <h1 class="text-2xl font-bold text-neutral-900">Edit Banner: {{ $banner->name }}</h1>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="p-4 space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">{{ $banner->created_at->format('M d, Y') }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-neutral-600">Updated</span>
                            <span class="font-medium">{{ $banner->updated_at->format('M d, Y') }}</span>
                        </div>
                    </div>
                </div>

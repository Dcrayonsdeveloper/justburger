...
<head>
    ...
    <title>Admin Sign In - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</title>
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required autofocus placeholder="admin@justburgers.com">
                    @error('email')

    ...
    <div class="invoice">
        ...
        <div class="header">
            <div class="header-left">
                <img src="/images/logo.svg" alt="{{ \App\Models\Setting::get('site_name', config('app.name')) }}" height="55" style="flex-shrink: 0;">
                <div>
            ...
            <div class="header-right">
                <div class="header-meta">
                    <strong>{{ \App\Models\Setting::get('site_name', config('app.name')) }}</strong><br>
                    <span style="font-size:11px;">{{ \App\Models\Setting::get('company_address', '525 Staines Road, Bedfont, TW14 8BP') }}</span><br>
                    <span style="font-size:11px;">VAT No: {{ \App\Models\Setting::get('company_vat_number', '') }}</span><br>
        ...
        <div class="meta-bar">
            ...
            <div class="meta-item">
                ...
                <div class="meta-value">{{ $order->currency ?? 'GBP' }}</div>
            </div>
        </div>
        ...
        <div class="totals-wrapper">
            <div class="totals">
                ...
                @if($taxAmount > 0)
                    <div class="totals-row">
                        <span class="totals-label">VAT ({{ $vatRate }}%)</span>
        ...
        {{-- Footer --}}
        <div class="footer">
            <div class="footer-thanks">Thank you for ordering from {{ \App\Models\Setting::get('site_name', config('app.name')) }}!</div>

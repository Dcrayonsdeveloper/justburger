                    ...
                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center shrink-0 overflow-hidden">
                            @if($testimonial->avatar_url)
                                <img src="{{ str_starts_with($testimonial->avatar_url, 'images/') ? asset($testimonial->avatar_url) : asset('storage/' . $testimonial->avatar_url) }}" alt="{{ $testimonial->name }}" class="w-full h-full object-cover">
                            @else

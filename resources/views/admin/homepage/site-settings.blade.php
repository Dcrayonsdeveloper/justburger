                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @if($settings['site_logo'])
                            <div class="mb-2">
                                <img src="{{ str_starts_with($settings['site_logo'], 'images/') ? asset($settings['site_logo']) : asset('storage/' . $settings['site_logo']) }}" alt="Current Logo" class="h-16 object-contain">
                            </div>
                        @endif

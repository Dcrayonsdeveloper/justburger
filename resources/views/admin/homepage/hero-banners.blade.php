                        ...
                        <div x-show="!editing">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="w-44 h-24 bg-neutral-100 rounded-lg overflow-hidden shrink-0">
                                    <img src="{{ str_starts_with($banner->image_url, 'images/') ? asset($banner->image_url) : asset('storage/' . $banner->image_url) }}" alt="{{ $banner->name }}" class="w-full h-full object-cover">
                                </div>

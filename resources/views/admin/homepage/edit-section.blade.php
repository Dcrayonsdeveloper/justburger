                    ...
                    @if($section->image_url !== null || in_array($section->type, ['cta', 'promo', 'product_banner']))
                        <div>
                            ...
                            @if($section->image_url)
                                <div class="mb-2">
                                    <img src="{{ str_starts_with($section->image_url, 'images/') ? asset($section->image_url) : asset('storage/' . $section->image_url) }}" alt="{{ $section->title }}" class="h-32 object-cover rounded-lg">
                                </div>
                            @endif

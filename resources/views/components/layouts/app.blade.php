...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="{{ \App\Models\Setting::get('site_name', 'JustBurgers') }}">
    <meta name="application-name" content="{{ \App\Models\Setting::get('site_name', 'JustBurgers') }}">
...
<body class="font-sans antialiased bg-[#111111] text-white" style="font-family: 'Barlow', sans-serif; overflow-x: clip;" x-data data-authenticated="{{ auth()->check() ? 'true' : 'false' }}">
    <!-- Toast Notifications -->
        ...
        <div x-show="$store.authModal.isOpen"
            ...
            <div x-show="$store.authModal.mode === 'login'"
                ...
                <form @submit.prevent="$store.authModal.login(email, password, remember)" class="space-y-4">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <a href="{{ route('password.request') }}" class="text-xs text-[#C8102E] hover:text-[#A00D24]">Forgot password?</a>
                        </div>
                ...
                <p class="mt-4 text-center text-sm text-neutral-600">
                    New to {{ \App\Models\Setting::get('site_name', config('app.name')) }}?
            ...
            <div class="px-6 pb-5 pt-2 text-center">
                <p class="text-[11px] text-neutral-600 leading-relaxed">
                    By continuing, I agree to {{ \App\Models\Setting::get('site_name', config('app.name')) }}'s
    ...
    <div x-data="pwaInstall()" x-show="showPrompt" x-cloak
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-[11px] font-semibold text-[#0F1111] leading-tight">Add {{ \App\Models\Setting::get('site_name', 'JustBurgers') }} to Home Screen</p>
            </div>

...
<section {{ $attributes->merge(['class' => 'py-8 border-t border-b border-[#E3E6E6] bg-white']) }}>
        ...
        <div class="flex md:hidden gap-4 overflow-x-auto pb-2" style="scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;">
            ...
            @foreach([
                ...
                <div class="flex items-center gap-3 shrink-0 bg-[#f8f6f3] rounded-xl px-4 py-3" style="min-width:200px;">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-[#0F1111]">{{ $badge['title'] }}</p>
                        <p class="text-[10px] text-[#565959]">{{ $badge['desc'] }}</p>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        <div class="hidden md:grid md:grid-cols-4 gap-8">
            ...
            <div class="flex flex-col items-center text-center gap-2.5 opacity-0 translate-y-4 transition-all duration-500 ease-out"
                ...
                <div class="w-14 h-14 flex items-center justify-center">
                    <svg class="w-10 h-10 text-[#205258]" fill="none" stroke="currentColor" stroke-width="1" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>
                    </svg>
                </div>
                <div>
                    <p class="text-sm font-semibold text-[#0F1111]">Free Delivery</p>
                    <p class="text-xs text-[#565959] mt-0.5">On qualifying orders</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center text-center gap-2.5 opacity-0 translate-y-4 transition-all duration-500 ease-out"
                ...
                <div>
                    <p class="text-sm font-semibold text-[#0F1111]">Freshly Prepared</p>
                    <p class="text-xs text-[#565959] mt-0.5">Made to order</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center text-center gap-2.5 opacity-0 translate-y-4 transition-all duration-500 ease-out"
                ...
                <div>
                    ...
                    <p class="text-xs text-[#565959] mt-0.5">100% safe & encrypted</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center text-center gap-2.5 opacity-0 translate-y-4 transition-all duration-500 ease-out"
                ...
                <div>
                    ...
                    <p class="text-xs text-[#565959] mt-0.5">100% fresh ingredients</p>
                </div>
            </div>
        </div>
    </div>

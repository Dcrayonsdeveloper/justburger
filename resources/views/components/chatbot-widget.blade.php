{{--
    JustBurgers AI Shopping Assistant Widget
...
>
    ...
    <div
        ...
        style="height: 520px; max-height: 80vh; transform-origin: bottom right;"
        role="dialog"
                                        ...
                                        <template x-for="product in msg.products" :key="product.id">
                                            ...
                                            >
                                                <div class="relative w-full aspect-square bg-neutral-50 overflow-hidden">
                                                    <img
                                                        :src="product.image || '/images/no-product-image.jpg'"
                                                        :alt="product.name"
                                                        class="w-full h-full object-cover"
                                                        loading="lazy"
                                                        onerror="this.src='/images/no-product-image.jpg'"
                                                    >

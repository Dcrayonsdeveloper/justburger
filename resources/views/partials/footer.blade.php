    ...
    <div class="container mx-auto px-6 lg:px-8 pt-14 pb-10">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-10 mb-14">
            ...
            <div class="col-span-2 sm:col-span-1">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="tel:{{ \App\Models\Setting::get('site_phone', '+4420889 05008') }}" class="text-sm text-white/60 hover:text-white transition-colors flex items-center gap-2">
                    ...
                    <li>
                        <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number', '447368429896') }}" target="_blank" rel="noopener" class="text-sm text-white/60 hover:text-white transition-colors flex items-center gap-2">
                            ...
                            {{ \App\Models\Setting::get('site_mobile', '+44 7368 429 896') }}
                        </a>
                    </li>
        ...
        <div class="border-t border-white/10 pt-8 mb-10">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div class="flex flex-wrap gap-x-6 gap-y-2 text-sm text-white/60">
                    <span>Mon–Tue: {{ \App\Models\Setting::get('hours_monday', '12:00 – 9:00 PM') }}</span>
                    <span>Wed–Thu: {{ \App\Models\Setting::get('hours_wednesday', '12:00 – 10:00 PM') }}</span>
                    <span>Fri–Sat: {{ \App\Models\Setting::get('hours_friday', '12:00 – 11:00 PM') }}</span>

...
<footer class="bg-[#111111] text-white mt-auto">
    ...
    <div class="container mx-auto px-6 lg:px-8 pt-14 pb-10">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-12">
            ...
            <div class="flex items-center gap-2.5">
                @if($socialFacebook)
                    <a href="{{ $socialFacebook }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="Facebook" target="_blank" rel="noopener">
                        <svg class="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                @endif
                @if($socialTwitter)
                    <a href="{{ $socialTwitter }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="X" target="_blank" rel="noopener">
                ...
                @endif
                @if($socialInstagram)
                    <a href="{{ $socialInstagram }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="Instagram" target="_blank" rel="noopener">
                ...
                @endif
                @if($socialSnapchat)
                    <a href="{{ $socialSnapchat }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="Snapchat" target="_blank" rel="noopener">
                ...
                @endif
                @if($socialTiktok)
                    <a href="{{ $socialTiktok }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="TikTok" target="_blank" rel="noopener">
                ...
                @endif
                @if($socialYoutube)
                    <a href="{{ $socialYoutube }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="YouTube" target="_blank" rel="noopener">
                ...
                @endif
                @if($socialSpotify)
                    <a href="{{ $socialSpotify }}" class="w-10 h-10 bg-white/10 hover:bg-white/20 text-white rounded-full flex items-center justify-center transition-colors" aria-label="Spotify" target="_blank" rel="noopener">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-10 mb-14">
            ...
            <div class="col-span-2 sm:col-span-1">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="tel:{{ \App\Models\Setting::get('site_phone', '02088905008') }}" class="text-sm text-white/60 hover:text-white transition-colors flex items-center gap-2">
                            ...
                            {{ \App\Models\Setting::get('site_phone', '02088905008') }}
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number', '447368998035') }}" target="_blank" rel="noopener" class="text-sm text-white/60 hover:text-white transition-colors flex items-center gap-2">
                            ...
                            {{ \App\Models\Setting::get('site_mobile', '07368998035') }}
                        </a>
                    </li>
                    <li class="text-sm text-white/60 flex items-start gap-2">
                        ...
                        <span>{{ \App\Models\Setting::get('site_address', '525 Staines Road, Bedfont, Middx. TW14 8BP') }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('products.index') }}" class="text-sm text-white/60 hover:text-white transition-colors">Full Menu</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('faq') }}" class="text-sm text-white/60 hover:text-white transition-colors">FAQs</a></li>
                    @guest
                        <li><a href="{{ route('login') }}" class="text-sm text-white/60 hover:text-white transition-colors">My Account</a></li>
                    @else
                        <li><a href="{{ route('account.dashboard') }}" class="text-sm text-white/60 hover:text-white transition-colors">My Account</a></li>
                    @endguest
                    <li><a href="{{ route('shipping') }}" class="text-sm text-white/60 hover:text-white transition-colors">Delivery Info</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('terms') }}" class="text-sm text-white/60 hover:text-white transition-colors">Terms & Conditions</a></li>
                    <li><a href="{{ route('privacy') }}" class="text-sm text-white/60 hover:text-white transition-colors">Privacy Policy</a></li>
                    <li><a href="{{ route('cookie-policy') }}" class="text-sm text-white/60 hover:text-white transition-colors">Cookie Policy</a></li>
                    <li><a href="{{ route('gdpr') }}" class="text-sm text-white/60 hover:text-white transition-colors">GDPR</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-white/10 pt-8 mb-10">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div class="flex flex-wrap gap-x-6 gap-y-2 text-sm text-white/60">
                    <span>Mon–Tue: {{ \App\Models\Setting::get('hours_monday', '12:00 – 10:00 PM') }}</span>
                    <span>Wed–Thu: {{ \App\Models\Setting::get('hours_wednesday', '12:00 – 10:30 PM') }}</span>
                    <span>Fri–Sat: {{ \App\Models\Setting::get('hours_friday', '11:45 AM – 11:00 PM') }}</span>
                    <span>Sun: {{ \App\Models\Setting::get('hours_sunday', '4:00 – 10:00 PM') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="border-t border-white/10">
        <div class="container mx-auto px-6 lg:px-8 py-5">
            <p class="text-xs text-white/40">&copy; {{ date('Y') }} {{ $siteName }}. All rights reserved.</p>
        </div>
    </div>
</footer>

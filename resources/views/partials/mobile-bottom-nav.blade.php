...
<nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-[#111111] border-t border-white/10 z-40 safe-area-inset-bottom">
    <div class="flex items-center justify-around h-16">
        ...
        @php $waPhone = preg_replace('/[^0-9]/', '', \App\Models\Setting::get('site_mobile', '')); @endphp
        <a href="{{ $waPhone ? 'https://wa.me/' . $waPhone . '?text=' . urlencode('Hi! I\'d like to place an order.') : route('products.index') }}"
           {{ $waPhone ? 'target="_blank" rel="noopener"' : '' }}

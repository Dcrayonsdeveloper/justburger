...
<head>
    ...
    <title>Delivery Partner Login - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</title>
...
<body class="antialiased bg-white min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-linear-to-br from-primary-900 via-primary-800 to-primary-950 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center px-12 xl:px-16">
            <img src="{{ asset('images/white_logo.webp') }}" alt="{{ \App\Models\Setting::get('site_name', config('app.name')) }}" class="h-12 object-contain object-left mb-8" onerror="this.style.display='none'">
    ...
    <div class="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 lg:px-16">
        <div class="w-full max-w-sm">
            {{-- Logo + Header --}}
            <div class="mb-8">
                <img src="{{ asset('images/logo.svg') }}" alt="{{ \App\Models\Setting::get('site_name', config('app.name')) }}" class="h-10 object-contain mb-4">

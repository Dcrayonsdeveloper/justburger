            ...
            <div class="flex-1">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                    <div>
                        ...
                        <p class="text-[16px] text-neutral-600 mt-1">Order {{ $order->order_number }}</p>
                    </div>
                ...
                {{-- Back to Order --}}
                <div class="mt-4">
                    <a href="{{ route('account.orders.show', $order) }}" class="text-[16px] text-primary-600 hover:text-primary-700 font-medium inline-flex items-center gap-1.5">

            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1 max-w-2xl">
                    ...
                    <div class="flex items-center gap-2 text-sm text-neutral-600 mb-5">
                        <a href="{{ route('account.reviews') }}" class="hover:text-[#205258] transition-colors">My Reviews</a>
                    ...
                    @else
                        ...
                        <div class="bg-white rounded-xl border border-neutral-200 p-4 mb-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="min-w-0">
                                    <a href="{{ route('product.show', $product) }}" class="text-sm font-semibold text-neutral-900 hover:text-[#205258] transition-colors line-clamp-1">
                                        {{ $product->name }}
                                    </a>
                                    @if($product->brand)
                                ...
                                <div class="p-5 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="title" id="title" value="{{ old('title') }}"
                                               ...
                                               class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 focus:border-[#205258]/50 focus:ring focus:ring-[#205258]/15 focus:ring-opacity-50">
                                        @error('title')
                                    ...
                                    <div>
                                        ...
                                        <textarea name="content" id="content" rows="4"
                                                  ...
                                                  class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 focus:border-[#205258]/50 focus:ring focus:ring-[#205258]/15 focus:ring-opacity-50 resize-none">{{ old('content') }}</textarea>
                                        @error('content')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <textarea name="pros" id="pros" rows="3"
                                                      ...
                                                      class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 focus:border-[#205258]/50 focus:ring focus:ring-[#205258]/15 focus:ring-opacity-50 resize-none">{{ old('pros') }}</textarea>
                                        </div>
                                        <div>
                                            ...
                                            <textarea name="cons" id="cons" rows="3"
                                                      ...
                                                      class="w-full rounded-lg border border-neutral-200 text-sm px-3 py-2.5 focus:border-[#205258]/50 focus:ring focus:ring-[#205258]/15 focus:ring-opacity-50 resize-none">{{ old('cons') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

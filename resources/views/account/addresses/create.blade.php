        ...
        <div class="container mx-auto px-4 py-8">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1 max-w-2xl">
                    <!-- Breadcrumb -->
                    <nav class="flex items-center gap-1.5 text-[16px] text-neutral-600 mb-5">
                        ...
                        <span class="text-neutral-600">Add New</span>
                    </nav>
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-neutral-900">Add New Address</h1>
                            <p class="text-[16px] text-neutral-600">This address will be available at checkout</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('account.addresses.store') }}" method="POST">
                        ...
                        <!-- Address Label -->
                        <div class="bg-white rounded-xl border border-neutral-100 p-5 mb-4" x-data="{ label: '{{ old('label', 'home') }}' }">
                        ...
                        <div class="bg-white rounded-xl border border-neutral-100 p-5 mb-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="name" class="block text-[16px] font-medium text-neutral-600 mb-1.5">Full Name <span class="text-error-500">*</span></label>
                                ...
                                <div>
                                    <label for="phone" class="block text-[16px] font-medium text-neutral-600 mb-1.5">Phone Number <span class="text-error-500">*</span></label>
                                    <div class="relative">
                        ...
                        <div class="bg-white rounded-xl border border-neutral-100 p-5 mb-4">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="address_line1" class="block text-[16px] font-medium text-neutral-600 mb-1.5">Address Line 1 <span class="text-error-500">*</span></label>
                                ...
                                <div>
                                    <label for="address_line2" class="block text-[16px] font-medium text-neutral-600 mb-1.5">Address Line 2 <span class="text-neutral-600 font-normal">(Optional)</span></label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="city" class="block text-[16px] font-medium text-neutral-600 mb-1.5">City <span class="text-error-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="state" class="block text-[16px] font-medium text-neutral-600 mb-1.5">State <span class="text-error-500">*</span></label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="postal_code" class="block text-[16px] font-medium text-neutral-600 mb-1.5">PIN Code <span class="text-error-500">*</span></label>
                        ...
                        <div class="flex items-center gap-3">
                            <button type="submit"
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white text-sm font-semibold rounded-lg hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('account.addresses.index') }}"
                               class="inline-flex items-center px-3 py-1.5 border border-neutral-200 text-sm font-medium text-neutral-600 rounded-lg hover:bg-neutral-50 hover:border-neutral-300 transition-all">
                                Cancel
                            </a>
                        </div>
                    </form>

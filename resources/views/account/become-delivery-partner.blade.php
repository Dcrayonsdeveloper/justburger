<x-layouts.app>
    <x-slot name="title">Become a Delivery Partner - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1" x-data="{
                ...
                {{-- Header --}}
                <div class="rounded-xl p-5 sm:p-6 mb-6 bg-gradient-to-r from-[#205258]/50 to-[#205258] text-white">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="phone" id="phone" value="{{ old('phone', auth()->user()->phone) }}" required
                                                   class="w-full px-3 py-2.5 bg-neutral-50 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:border-[#205258] focus:ring-0 transition-colors"
                ...
                <div x-show="currentStep === 2" x-cloak>
                            ...
                            <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                                ...
                                <div class="p-5 space-y-5">
                                    ...
                                    <div>
                                        ...
                                        @endif
                                        <label class="flex items-center justify-center gap-2 w-full px-4 py-3 border-2 border-dashed border-neutral-300 rounded-lg cursor-pointer hover:border-[#205258] hover:bg-[#205258]/5/50 transition-colors">
                    ...
                    @else
                        <div class="bg-white border border-neutral-100 rounded-xl p-6 text-center">
                            ...
                            <button @click="currentStep = 1" class="mt-3 text-sm text-[#205258] hover:text-[#1b454a] font-medium">Go to Step 1</button>
                        </div>
                    @endif
                </div>
                            ...
                            <div class="p-6 sm:p-8 text-center">
                                ...
                                @else
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                                        <button @click="currentStep = 2" class="text-sm text-[#205258] hover:text-[#1b454a] font-medium inline-flex items-center gap-1.5">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                            Update Documents
                                        </button>
                                    </div>

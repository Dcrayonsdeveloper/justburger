<aside class="lg:w-60 shrink-0">
    <nav class="bg-white border border-neutral-100 rounded-xl p-3 space-y-0.5">
        ...
        <a href="{{ route('wishlist') }}"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[16px] font-medium {{ request()->routeIs('wishlist*') ? 'bg-primary-50 text-primary-600' : 'text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900' }} transition-colors">
            <svg class="w-4.5 h-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('account.addresses.index') }}"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[16px] font-medium {{ request()->routeIs('account.addresses*') ? 'bg-primary-50 text-primary-600' : 'text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900' }} transition-colors">
            <svg class="w-4.5 h-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('account.returns.index') }}"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[16px] font-medium {{ request()->routeIs('account.returns*') ? 'bg-primary-50 text-primary-600' : 'text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900' }} transition-colors">
            <svg class="w-4.5 h-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('account.reviews') }}"
           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[16px] font-medium {{ request()->routeIs('account.reviews*') ? 'bg-primary-50 text-primary-600' : 'text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900' }} transition-colors">
            <svg class="w-4.5 h-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="pt-3 mt-3 border-t border-neutral-100">
            @if(auth()->user()->deliveryPartner)
                <a href="{{ route('delivery.login') }}"
                   class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[16px] font-medium text-[#205258] hover:bg-[#205258]/5 transition-colors">
                    <svg class="w-4.5 h-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @else
                <a href="{{ route('account.become-delivery-partner') }}"
                   class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[16px] font-medium {{ request()->routeIs('account.become-delivery-partner') ? 'bg-primary-50 text-primary-600' : 'text-[#205258] hover:bg-[#205258]/5' }} transition-colors">
                    <svg class="w-4.5 h-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/>
                    </svg>

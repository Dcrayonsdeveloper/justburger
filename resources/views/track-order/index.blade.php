        ...
        <div class="max-w-md mx-auto">
            ...
            @auth
                <div class="bg-green-50 border border-green-200 rounded-xl p-3 mb-4 flex items-center gap-2">
                    ...
                    <p class="text-[16px] text-green-700">Signed in as <span class="font-semibold">{{ auth()->user()->email }}</span> — just enter your order number.</p>
                </div>
            @endauth
            ...
            <div class="bg-white border border-neutral-100 rounded-xl">
                <form action="{{ route('track-order.track') }}" method="POST" class="p-5 sm:p-6 space-y-4">
                    @csrf
                    <div>
                        <label class="block text-[16px] font-medium text-neutral-700 mb-1.5">Order Number</label>
                    ...
                    @guest
                        <div>
                            <label class="block text-[16px] font-medium text-neutral-700 mb-1.5">Email Address</label>
            ...
            @auth
                <p class="text-center text-[16px] text-neutral-600 mt-4">

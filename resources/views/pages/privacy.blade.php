<x-layouts.app>
    <x-slot name="title">Privacy Policy - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Read the privacy policy of {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Learn how we collect, use, and protect your personal information.">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div class="w-14 h-14 mx-auto rounded-full bg-[#205258]/5 flex items-center justify-center mb-4">
                    <svg class="w-7 h-7 text-[#205258]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-[16px] text-neutral-600 mt-2">Last updated: {{ \Carbon\Carbon::now()->format('F Y') }} &middot; We are committed to protecting your personal data.</p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 mb-3">We collect information you provide directly and data collected automatically when you use our services:</p>
                <ul class="space-y-2">
                    <li class="flex items-start gap-2 text-[16px] text-neutral-600">
                        <svg class="w-4 h-4 text-[#205258] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 mb-3 leading-relaxed">We do not sell, trade, or rent your personal information to third parties. We may share data only in these circumstances:</p>
                <ul class="space-y-2">
                    <li class="flex items-start gap-2 text-[16px] text-neutral-600">
                        <svg class="w-4 h-4 text-[#205258] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 leading-relaxed">We implement SSL/TLS encryption, secure storage, and regular security audits. Payment information is handled by PCI-DSS compliant providers and never stored on our servers.</p>
                </div>
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    <h2 class="text-[15px] font-bold text-neutral-900 mb-2">Data Retention</h2>
                    <p class="text-[16px] text-neutral-600 leading-relaxed">Data is retained while your account is active or as needed for services. Order records are kept for 7 years for legal compliance. You can request deletion at any time.</p>
                </div>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div class="flex items-start gap-2 text-[16px] text-neutral-600">
                        <svg class="w-4 h-4 text-[#205258] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                ...
                <p class="text-[16px] text-neutral-600 mt-3">See our <a href="{{ route('gdpr') }}" class="text-primary-600 hover:text-primary-700 font-medium">GDPR Compliance</a> page for full details on your rights.</p>
            </div>

            {{-- Children notice --}}
            <div class="bg-[#205258]/5 border border-[#205258]/20 rounded-xl p-5 sm:p-6 mb-4">
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 bg-[#205258]/10 rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-[16px] text-neutral-600 leading-relaxed">Our services are not directed to children under 13. We do not knowingly collect personal information from children. If you believe a child has provided us with personal data, please contact us and we will promptly delete it.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 text-center">
                ...
                <p class="text-[16px] text-neutral-600 mb-4">If you have any questions or want to exercise your rights, contact us and we will respond promptly.</p>
                <div class="flex flex-wrap items-center justify-center gap-3">
                    ...
                    <a href="{{ route('cookie-policy') }}" class="inline-flex items-center gap-2 px-4 py-2 text-[16px] font-medium text-neutral-700 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
                        Cookie Policy
                    </a>
                    <a href="{{ route('gdpr') }}" class="inline-flex items-center gap-2 px-4 py-2 text-[16px] font-medium text-neutral-700 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
                        GDPR Compliance
                    </a>
                </div>
            </div>

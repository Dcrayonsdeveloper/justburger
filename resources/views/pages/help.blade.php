<x-layouts.app>
    <x-slot name="title">Help Center - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Need help? Visit the {{ \App\Models\Setting::get('site_name', config('app.name')) }} help center for answers about orders, delivery, refunds, and account management.">
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-8 sm:mb-10">
                ...
                <p class="text-[16px] text-neutral-600 mt-2">How can we help you today?</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-10">
                ...
                <a href="{{ route('account.orders.index') }}" class="bg-white border border-neutral-100 rounded-xl p-5 hover:border-info-200 hover:shadow-sm transition-all group">
                    ...
                    <p class="text-xs text-neutral-600 leading-relaxed">Track orders, view history, and manage refunds.</p>
                </a>
                ...
                <a href="{{ route('shipping') }}" class="bg-white border border-neutral-100 rounded-xl p-5 hover:border-success-200 hover:shadow-sm transition-all group">
                    ...
                    <h3 class="text-sm font-semibold text-neutral-900 mb-1 group-hover:text-success-600 transition-colors">Delivery</h3>
                    <p class="text-xs text-neutral-600 leading-relaxed">Delivery options, delivery times, and costs.</p>
                </a>
                ...
                <a href="{{ route('returns') }}" class="bg-white border border-neutral-100 rounded-xl p-5 hover:border-warning-200 hover:shadow-sm transition-all group">
                    ...
                    <h3 class="text-sm font-semibold text-neutral-900 mb-1 group-hover:text-warning-600 transition-colors">Refunds</h3>
                    <p class="text-xs text-neutral-600 leading-relaxed">How to request a refund if something's not right.</p>
                </a>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                    <div class="text-center">
                        ...
                        <a href="{{ route('contact') }}" class="inline-flex items-center px-4 py-2 text-[16px] font-medium text-primary-600 border border-primary-200 rounded-lg hover:bg-primary-50 transition-colors">Send Email</a>
                    </div>
                    <div class="text-center">
                        <div class="w-11 h-11 bg-primary-50 rounded-full flex items-center justify-center mx-auto mb-3">
                            <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number', '447368998035') }}" target="_blank" class="inline-flex items-center px-4 py-2 text-[16px] font-medium text-primary-600 border border-primary-200 rounded-lg hover:bg-primary-50 transition-colors">{{ \App\Models\Setting::get('site_phone', '020 8890 5008') }}</a>
                    </div>
                </div>
            </div>
        </div>

<x-layouts.app>
    <x-slot name="title">GDPR Compliance - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="GDPR compliance information for {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Learn about your data rights and how we protect your privacy.">
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-[16px] text-neutral-600 mt-2">General Data Protection Regulation — Your rights under EU/UK law.</p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 leading-relaxed">
                    The General Data Protection Regulation (GDPR) is a regulation in EU law on data protection and privacy. It gives individuals control over their personal data and simplifies the regulatory environment for international business. {{ \App\Models\Setting::get('site_name', config('app.name')) }} is committed to full compliance with all GDPR obligations.
                </p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600">To exercise any right, contact us via the form below. We will respond within <strong>30 days</strong>. You also have the right to lodge a complaint with your local data protection authority.</p>
            </div>

            {{-- Data Retention --}}
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                <h2 class="text-[15px] font-bold text-neutral-900 mb-3">Data Retention</h2>
                <p class="text-[16px] text-neutral-600 mb-3 leading-relaxed">We retain personal data only for as long as necessary for the purposes for which it was collected.</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 leading-relaxed">We use carefully selected service providers bound by GDPR-compliant data processing agreements — including payment gateways, shipping carriers, email providers, analytics services, and cloud infrastructure.</p>
                </div>
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    <h2 class="text-[15px] font-bold text-neutral-900 mb-2">International Transfers</h2>
                    <p class="text-[16px] text-neutral-600 leading-relaxed">Where we transfer data outside the EEA or UK, we ensure appropriate safeguards are in place — such as standard contractual clauses or adequacy decisions.</p>
                </div>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 text-center">
                ...
                <p class="text-[16px] text-neutral-600 mb-4">To exercise your GDPR rights, contact us below. Please include <strong>"GDPR Request"</strong> in your message and specify which right you are exercising. We aim to respond within 30 days.</p>

<x-layouts.app>
    <x-slot name="title">{{ $page->seo_data['meta_title'] ?? $page->title }} - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 text-center">
                ...
                <div class="flex flex-wrap items-center justify-center gap-3">
                    ...
                    @if($page->slug !== 'terms-of-service')
                        <a href="{{ route('terms') }}" class="inline-flex items-center gap-2 px-4 py-2 text-[16px] font-medium text-neutral-700 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
                            Terms of Service
                        </a>
                    @endif

                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number', '447368998035') }}?text={{ urlencode('Hi! I\'d like to place an order please.') }}" target="_blank" rel="noopener"
                                    ...
                                    <a href="tel:{{ \App\Models\Setting::get('site_phone', '02088905008') }}"
                                       class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold text-white border border-white/20 hover:bg-white/10 transition-colors">
                                        ...
                                        Call {{ \App\Models\Setting::get('site_phone', '020 8890 5008') }}
                                    </a>
                                </div>
                            </div>
                        </div>

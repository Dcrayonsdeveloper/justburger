<x-layouts.app>
    <x-slot name="title">Sitemap - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Complete sitemap of {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Browse all pages, products, categories, and brands.">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded border border-[#E3E6E6] p-5">
                    ...
                    <ul class="space-y-1.5 text-sm">
                        ...
                        <li><a href="{{ route('products.index') }}" class="text-[#007185] hover:text-[#C7511F] hover:underline">Categories</a></li>
                ...
                <div class="bg-white rounded border border-[#E3E6E6] p-5">
                    ...
                    <ul class="space-y-1.5 text-sm">
                        ...
                        <li><a href="{{ route('shipping') }}" class="text-[#007185] hover:text-[#C7511F] hover:underline">Delivery Information</a></li>

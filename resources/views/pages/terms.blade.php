<x-layouts.app>
    <x-slot name="title">Terms of Service - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Terms of service for {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Read our terms and conditions for shopping online.">
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-[16px] text-neutral-600 mt-2">Last updated: {{ \Carbon\Carbon::now()->format('F Y') }} &middot; Please read these terms carefully before using our services.</p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 leading-relaxed">
                    By accessing or using the {{ \App\Models\Setting::get('site_name', config('app.name')) }} website or placing an order, you confirm that you have read, understood, and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use our services.
                </p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 mb-3">You are granted a limited, non-exclusive, non-transferable licence to access and use our website for personal, non-commercial purposes, subject to these terms. You agree to:</p>
                <ul class="space-y-2">
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 mb-3">You must not use our website to:</p>
                <ul class="space-y-2">
                    <li class="flex items-start gap-2 text-[16px] text-neutral-600">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 leading-relaxed">All content on this website — including text, images, logos, and design — is the property of {{ \App\Models\Setting::get('site_name', config('app.name')) }} and is protected by copyright and trademark laws. Unauthorised use is strictly prohibited.</p>
                </div>
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    <h2 class="text-[15px] font-bold text-neutral-900 mb-2">Product Information</h2>
                    <p class="text-[16px] text-neutral-600 leading-relaxed">We strive for accuracy in all product descriptions and pricing. However, we do not warrant that all information is error-free. We reserve the right to correct any errors and update information at any time without prior notice.</p>
                </div>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 leading-relaxed">To the maximum extent permitted by law, {{ \App\Models\Setting::get('site_name', config('app.name')) }} shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our website or services. Our total liability shall not exceed the amount paid by you for the specific product or service giving rise to the claim.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 leading-relaxed">These Terms shall be governed by and construed in accordance with applicable law. Any disputes shall be resolved through the courts of the applicable jurisdiction, unless otherwise agreed.</p>
                </div>
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    <h2 class="text-[15px] font-bold text-neutral-900 mb-2">Changes to Terms</h2>
                    <p class="text-[16px] text-neutral-600 leading-relaxed">We reserve the right to modify these Terms at any time. Changes take effect immediately upon posting. Continued use of our website after changes constitutes your acceptance of the new terms.</p>
                </div>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 text-center">
                ...
                <p class="text-[16px] text-neutral-600 mb-4">If you have questions about these Terms of Service, please contact our support team.</p>
                <div class="flex flex-wrap items-center justify-center gap-3">
                    ...
                    <a href="{{ route('privacy') }}" class="inline-flex items-center gap-2 px-4 py-2 text-[16px] font-medium text-neutral-700 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
                        Privacy Policy
                    </a>
                </div>
            </div>

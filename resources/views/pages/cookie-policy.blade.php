<x-layouts.app>
    <x-slot name="title">Cookie Policy - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Cookie policy for {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Learn how we use cookies to improve your shopping experience.">
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-[16px] text-neutral-600 mt-2">Last updated: {{ \Carbon\Carbon::now()->format('F Y') }} &middot; How we use cookies and similar technologies on our website.</p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 mb-3">Required for the website to function properly. These cannot be disabled.</p>
                <ul class="space-y-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 mb-3">Enhance your experience by remembering preferences and settings.</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 mb-3">Help us understand how visitors use our website so we can improve it.</p>
                    <ul class="space-y-1.5">
                        <li class="flex items-start gap-2 text-[16px] text-neutral-600">
                            <svg class="w-4 h-4 text-success-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                ...
                <p class="text-[16px] text-neutral-600 mb-3">Used to show relevant advertisements and measure campaign effectiveness.</p>
                <ul class="space-y-2">
                    <li class="flex items-start gap-2 text-[16px] text-neutral-600">
                        <svg class="w-4 h-4 text-success-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    ...
                    <p class="text-[16px] text-neutral-600 leading-relaxed">Some cookies are set by third-party services on our pages. We do not control these cookies — please refer to each third party's privacy policy for details on how they collect and use data.</p>
                </div>
                <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6">
                    <h2 class="text-[15px] font-bold text-neutral-900 mb-2">Managing Cookies</h2>
                    <p class="text-[16px] text-neutral-600 leading-relaxed">You can control cookies through your browser settings. Most browsers allow you to block or delete cookies. You can also browse in private/incognito mode to prevent cookies being saved after your session.</p>
                </div>
            </div>
            ...
            <div class="bg-warning-50 border border-warning-200 rounded-xl p-5 sm:p-6 mb-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[16px] text-neutral-600 leading-relaxed">Disabling certain cookies may affect the functionality of our website. Features such as staying logged in, keeping items in your cart, and remembering your preferences may not work correctly without essential cookies enabled.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 text-center">
                ...
                <p class="text-[16px] text-neutral-600 mb-4">If you have questions about how we use cookies, our support team is here to help.</p>

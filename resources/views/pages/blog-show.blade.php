            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 min-w-0">
                    ...
                    <div class="flex items-center gap-2 mb-4 flex-wrap">
                        ...
                        @endif
                        <span class="text-[16px] text-neutral-600">{{ $post->reading_time }} min read</span>
                        <span class="text-neutral-300">·</span>
                        <span class="text-[16px] text-neutral-600">{{ $post->published_at?->format('M d, Y') }}</span>
                        <span class="text-neutral-300">·</span>
                        <span class="text-[16px] text-neutral-600">{{ number_format($post->view_count) }} views</span>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-8 mb-6">
                        ...
                        @else
                            <p class="text-neutral-600 italic text-[16px]">No content available.</p>
                        @endif
                    </div>

                    {{-- Share --}}
                    <div class="flex items-center gap-3 mb-6">
                        <span class="text-[16px] text-neutral-500 font-medium">Share:</span>
                    ...
                    @if($post->tags && count($post->tags))
                        <div class="flex flex-wrap gap-2 mb-6">
                            <span class="text-[16px] text-neutral-600 font-medium self-center">Tags:</span>
                            @foreach($post->tags as $tag)
                                <span class="px-3 py-1 bg-neutral-100 text-neutral-600 rounded-full text-[16px]">{{ $tag }}</span>
                            @endforeach
                        </div>
                    @endif
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            ...
                            <a href="{{ route('products.show', $rProduct->slug) }}" class="group">
                                ...
                                <div class="flex items-center gap-1.5 mt-1">
                                    <span class="text-[16px] font-bold text-neutral-900">@price($rProduct->price)</span>
                    ...
                    {{-- Back link --}}
                    <a href="{{ route('blog') }}" class="inline-flex items-center gap-2 text-[16px] font-medium text-primary-600 hover:text-primary-700 transition-colors">
                        ...
                        <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                                        ...
                                        <a href="{{ route('blog.show', $rPost->slug) }}"
                                           class="flex items-start gap-3 p-3 hover:bg-neutral-50 transition-colors group">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <p class="text-[16px] font-semibold text-neutral-900 line-clamp-2 group-hover:text-primary-600 transition-colors leading-snug">
                                                    {{ $rPost->title }}
                                                </p>
                                                <div class="flex items-center gap-1.5 mt-1">
                                                    @if($rPost->category)
                            ...
                            @else
                                <div class="p-4 text-center">
                                    <p class="text-[16px] text-neutral-600">No other articles yet.</p>
                                </div>
                            @endif
                        </div>

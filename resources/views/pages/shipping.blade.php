                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="tel:{{ \App\Models\Setting::get('site_phone', '02088905008') }}" class="text-sm font-bold text-[#C8102E] mt-1.5 block">{{ \App\Models\Setting::get('site_phone', '02088905008') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number', '447368998035') }}" target="_blank" class="text-sm font-bold text-green-600 mt-1.5 block">{{ \App\Models\Setting::get('site_mobile', '07368998035') }}</a>
                            </div>
                        </div>
                    </div>
            ...
            <div x-data="{ open: null }" class="space-y-3">
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 5" x-collapse>
                        <div class="px-5 pb-4 text-[16px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">If anything isn't right with your order, please let us know straight away. Call us on {{ \App\Models\Setting::get('site_phone', '02088905008') }} or WhatsApp {{ \App\Models\Setting::get('site_mobile', '07368998035') }} and we'll sort it out for you.</p>
                        </div>
                    </div>
                </div>
            </div>

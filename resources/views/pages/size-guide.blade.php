<x-layouts.app>
    <x-slot name="title">Size Guide - {{ \App\Models\Setting::get('site_name', config('app.name')) }}</x-slot>

    @push('meta')
        <meta name="description" content="Product size guide at {{ \App\Models\Setting::get('site_name', config('app.name')) }}. Find the perfect size with our sizing charts.">

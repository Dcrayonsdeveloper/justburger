...
Route::prefix('webhook')->middleware(VerifyMetaWebhookSignature::class)->group(function () {
...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('checkout')->name('checkout.')->group(function () {
            Route::post('validate', [\App\Http\Controllers\Api\V1\CheckoutController::class, 'validate'])->name('validate');
            Route::post('/', [\App\Http\Controllers\Api\V1\CheckoutController::class, 'process'])->name('process');
        });

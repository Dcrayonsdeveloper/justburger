...
class ChatbotController extends Controller
{
    ...
    {
        $storeName = Setting::get('site_name', config('app.name', 'JustBurgers'));
        ...
        $prompt .= "- Warm, friendly, and enthusiastic about helping customers find what they need.\n";
        ...
        $prompt .= "## Restaurant Policies\n";
        $prompt .= "- **Delivery**: Free delivery on orders above £15. Delivery within our local area, usually 30–45 minutes.\n";
        $prompt .= "- **Collection**: Order online and collect from our restaurant.\n";
        $prompt .= "- **Payments**: All major cards, Apple Pay, Google Pay, and cash on collection.\n";
        $prompt .= "- **Refunds**: Food orders are non-returnable once delivered. Refunds for wrong or damaged orders only.\n";

...
class HomeController extends Controller
{
    public function index(): View
    {
        ...
        $siteSettings = [
            'site_name' => Setting::get('site_name', 'JustBurgers'),
            'site_tagline' => Setting::get('site_tagline', 'Fresh Burgers, Bold Flavors'),
            'site_logo' => Setting::get('site_logo', ''),
            'footer_about' => Setting::get('footer_about', 'JustBurgers is your destination for fresh, handcrafted burgers made with 100% premium beef, crispy sides, and refreshing drinks.'),
        ];

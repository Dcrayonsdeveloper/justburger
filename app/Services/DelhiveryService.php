...
class DelhiveryService
{
    ...
    public function __construct()
    {
        ...
        $this->pickupLocation = Setting::get('delhivery_pickup_location', 'JustBurgers Warehouse');
    ...
    public function bookDelivery(\App\Models\Order $order): array
    {
        ...
        $shipmentData = [
            ...
            'return_name' => Setting::get('delhivery_return_name', 'JustBurgers Returns'),
            ...
            'seller_name' => config('app.name', 'JustBurgers'),

...
class ReviewGeneratorService
{
    ...
    public function generateStandaloneReview(Product $product, ?string $guestName = null, ?float $targetAvg = null, ?\Carbon\Carbon $createdAt = null): Review
    {
        ...
        $review = Review::create([
            ...
            'guest_email' => 'review' . mt_rand(10000, 99999) . '@customer.justburgers.com',
            'rating' => $rating,
            'title' => $this->generateTitle($product, $rating),
            'content' => $this->generateContent($product, $rating),
            'pros' => $this->generatePros($product, $rating),
    ...
    private function getTitleTemplates(int $rating): array
    {
        return match (true) {
            ...
            $rating >= 4 => [
                ...
                'Does the job well',
                'Decent {product_type} from JustBurgers',
    ...
    private function getContentTemplates(int $rating): array
    {
        return match (true) {
            $rating >= 5 => [
                ...
                'Excellent product! The {product_type} works perfectly and feels very well built. Will definitely order more from JustBurgers.',
                'Very impressed with this {product_type}. It is exactly as shown in the pictures. Fast shipping too! No complaints at all.',
                'This is my third purchase from JustBurgers and every time the quality has been consistent. This {product_type} is no exception.',
                ...
                'Just received this {product_type} and I am thoroughly impressed. Would definitely order from JustBurgers again.',
                ...
                'My wife also liked it so much she asked me to order one more. Great quality {product_type} from JustBurgers.',
                ...
                'Really pleased with this purchase. The {product_type} is well-built and performs flawlessly. Good experience shopping at JustBurgers. The delivery was quick and the packaging was nice. I have already recommended this to my colleagues.',
                'This {product_type} from JustBurgers exceeded my expectations completely. The material and build quality are really good. Have been using it for {timeframe} and it is holding up great. I initially had doubts because of the low price but this is genuinely premium quality. Very impressed.',
                'Let me share my honest experience. I ordered this {product_type} after reading other reviews and I am glad I did. The quality is exactly what they describe. I have been using it daily for {timeframe} now and there are zero issues. The build feels sturdy, the performance is consistent, and the design looks great. This is the kind of product that makes you trust a brand. Will be ordering more from JustBurgers for sure.',
                ...
                'I bought this as a gift for my father and he absolutely loves it. The {product_type} looks premium, works great, and the packaging made it feel like a proper gift. Dad has been using it for {timeframe} now and keeps telling me how good it is. JustBurgers has earned a loyal customer. Already planning to buy more products from here.',
            ...
            $rating >= 4 => [
                ...
                'Solid {product_type} from JustBurgers. Been using it for {timeframe}. Good quality but delivery took a bit longer than expected.',
                ...
                'Nice {product_type} from JustBurgers. Performance is good and the design looks nice. Value for money. Would buy again.',

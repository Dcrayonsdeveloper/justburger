...
class Banner extends Model
{
    ...
    {
        if (!$this->image_url) return asset('images/placeholder-banner.jpg');
        return str_starts_with($this->image_url, 'images/')
    ...
    {
        if (!$this->mobile_image_url) return $this->image;
        return str_starts_with($this->mobile_image_url, 'images/')
            ? asset($this->mobile_image_url)

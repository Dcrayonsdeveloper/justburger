...
{
    protected $signature = 'justburgers:import-products {file? : Path to CSV file}';
    protected $description = 'Import products from Shopify CSV export into JustBurgers';
    ...
    private function createCategories(array $products): void
    {
        ...
        foreach ($categoryPaths as $path) {
            ...
            $parent = Category::create([
                ...
                'description' => "Shop {$topLevel} at JustBurgers",
                'position' => $position++,
                'is_active' => true,
        ...
        foreach ($categoryPaths as $path) {
            ...
            $cat = Category::create([
                ...
                'description' => "Shop {$subLevel} at JustBurgers",
                'position' => 1,
                'is_active' => true,
            ]);
    ...
    private function importProduct(array $data): void
    {
        ...
        $seoTitle = $data['seo_title'] ?: $data['title'] . ' - Buy Online at ' . config('app.name', 'JustBurgers');
        ...
        $product = Product::create([
            ...
            'seo_data' => [
                'title' => $seoTitle,
                'description' => $seoDesc,
                'keywords' => strtolower($data['title']) . ', buy online, justburgers',
            ],
